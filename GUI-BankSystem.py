...
def Cr_Amt(accnt,name):
	creditwn=tk.Tk()
	creditwn.geometry("600x600")
	creditwn.title("Credit Amount")
	creditwn.configure(bg="white")
	fr1=tk.Frame(creditwn,bg="cyan")
	l_title=tk.Message(creditwn,text="MY BANK",relief="raised",width=1000,padx=500,pady=10,fg="white",bg="black",justify="center",anchor="center")
...
def De_Amt(accnt,name):
	debitwn=tk.Tk()
	debitwn.geometry("600x600")
	debitwn.title("Debit Amount")	
	debitwn.configure(bg="white")
	fr1=tk.Frame(debitwn,bg="cyan")
	l_title=tk.Message(debitwn,text="MY BANK",relief="raised",width=2000,padx=500,pady=10,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","italic"))
	l_title.pack(side="top")
...
def disp_tr_hist(accnt):
	disp_wn=tk.Tk()
	disp_wn.geometry("900x560")
	disp_wn.title("Transaction History")
	disp_wn.configure(bg="white")
	fr1=tk.Frame(disp_wn,bg="blue")
	l_title=tk.Message(disp_wn,text="MY BANK",relief="raised",width=1080,padx=500,pady=10,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","italic"))
	l_title.pack(side="top")
	fr1=tk.Frame(disp_wn)
	fr1.pack(side="top")
	l1=tk.Message(disp_wn,text="Your Transaction History:",padx=900,pady=20,width=1000,bg="cyan",fg="black",relief="raised")
	l1.pack(side="top")
	...
	for line in frec:
		...
		l.pack(side="top")
	b=tk.Button(disp_wn,text="Quit",relief="raised",command=disp_wn.destroy,width=10)
	b.pack(side="top")
	frec.close()

def logged_in_menu(accnt,name):
	rootwn=tk.Tk()
	rootwn.geometry("1500x1600")
	rootwn.title("MY BANK-"+name)
	rootwn.configure(background='cyan')
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
	l_title=tk.Message(rootwn,text="SIMPLE BANKING\n MANAMMENT SYSTEM",relief="raised",width=20000,padx=500,pady=10,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","italic"))
	l_title.pack(side="top")
...
def log_in(master):
	master.destroy()
	loginwn=tk.Tk()
	loginwn.geometry("1600x1600")
	loginwn.title("Log in")
	loginwn.configure(bg="cyan")
	fr1=tk.Frame(loginwn,bg="blue")
	l_title=tk.Message(loginwn,text="MY BANK",relief="raised",width=2000,padx=500,pady=10,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","italic"))
	l_title.pack(side="top")
...
def Create():
	...
	crwn=tk.Tk()
	crwn.geometry("1600x1600")
	crwn.title("Create Account")
	crwn.configure(bg="cyan")
	fr1=tk.Frame(crwn,bg="blue")
	l_title=tk.Message(crwn,text="MY BANK",relief="raised",width=2000,padx=500,pady=10,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","italic"))
	l_title.pack(side="top")
...
def Main_Menu():
	...
	x.place(y=-400)
	l_title=tk.Message(text="SIMPLE BANKING\n MANAGMENT SYSTEM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","italic"))
	l_title.pack(side="top")
	imgc1=tk.PhotoImage(file="new.gif")
	imglo=tk.PhotoImage(file="login.gif")
	imgc=imgc1.subsample(2,3)
	imglog=imglo.subsample(2,3)
